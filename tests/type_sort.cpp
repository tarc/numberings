...
{
    BOOST_STATIC_ASSERT((boost::mpl::equal<numberings::type_sort<int>::type, boost::mpl::vector<int>>::type::value));
}

TEST_F(TypeSortTest, fixedWidthIntSequence)
{
    BOOST_STATIC_ASSERT((boost::mpl::equal<numberings::type_sort<uint64_t, int32_t, int16_t, uint8_t>::type,
